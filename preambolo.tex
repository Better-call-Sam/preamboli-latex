...
\setlength{\cftbeforesecskip}{1.5ex} % Spazio extra prima delle sezioni
...
\newcommand{\pw}{\ifmmode \Psi_w \else $\Psi_w$ \fi} %potenziale idrico 
\newcommand{\ps}{\ifmmode \Psi_s \else $\Psi_s$ \fi}
\newcommand{\pp}{\ifmmode \Psi_p \else $\Psi_p$ \fi}  


\newcommand{\gramp}{\ifmmode \textnormal{GRAM}^+ \else GRAM$^+$ \fi}
\newcommand{\gramm}{\ifmmode \textnormal{GRAM}^- \else GRAM$^-$ \fi} 
...
\newcommand{\verdone} [1] {\textcolor {verdone}{#1}}
...
% Indice con le voci di \section interamente in cobalto.
% L'argomento opzionale regola la larghezza riservata al numero di sezione.
\newcommand{\indicecobalto}[1][3em]{%
  \begingroup
    \setlength{\cftsecnumwidth}{#1}%
    \renewcommand{\cftsecfont}{\color{cobalto}\Large\bfseries}%
    \renewcommand{\cftsecpagefont}{\color{cobalto}\Large\bfseries}%
    \renewcommand{\cftsecleader}{\color{cobalto}\cftdotfill{\cftdotsep}}%
    % Mantiene cliccabili le voci e colora solo i link delle \section.
    \let\indiceorigcontentsline\contentsline
    \def\contentsline##1##2##3##4{%
      \begingroup
        \ifstrequal{##1}{section}%
          {\hypersetup{linkcolor=cobalto}}%
          {\hypersetup{linkcolor=black}}%
        \indiceorigcontentsline{##1}{##2}{##3}{##4}%
      \endgroup
    }%
    \tableofcontents
  \endgroup
